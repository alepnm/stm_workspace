...
static const MotorParamSet ParamSet0 = {
    .ID = 0x00, .StepsPerRev = 200,
    .Kval = { .RunValue = 42, .AccValue = 44, .DecValue = 40, .HoldValue = 5 },
    .Treshold = { .OcdValue = 2000, .StallValue = 2000 },
    .Speed = { .Acceleration = 100, .Deceleration = 100 }
};
...
static const MotorParamSet ParamSet1 = {
    ...
    .Treshold = { .OcdValue = 3500, .StallValue = 3500 },
    .Speed = { .Acceleration = 100, .Deceleration = 100 }
};
...
static const MotorParamSet ParamSet2 = {
    ...
    .Treshold = { .OcdValue = MAX_TRES_OCD_MA_DEF, .StallValue = ( MAX_TRES_OCD_MA_DEF - 500 )},
    .Speed = { .Acceleration = 100, .Deceleration = 100 }
};
